...
Feature: Login into saucedemo, add items to the shopping cart, remove products, and check the number of items in the cart.
	...
	As a client I want to checkout the products I added to the shopping cart to make the order with the products I added
	...
	Scenario: Correctly checkout the products
	Given I have products in my shopping cart
	...
	Scenario: Incorrectly checkout the products
	Given I have products in my shopping cart
	When I checkout my products
	And I don't enter my personal information
